...
export default function Footer() {
  return (
    <footer
      ...
      className="flex w-full bg-[#ee5522] dark:bg-black flex-row  flex-wrap items-center justify-center gap-y-6 gap-x-12 border-t border-blue-gray-50 py-6 text-center md:justify-between px-4"
    >
      <Typography
      ...
      >
        &copy; 2024 AYMEN BACHIRI, All rights Reserved
      </Typography>
      <ul className="flex flex-wrap items-center gap-y-2 gap-x-8">
        <li>
          <Typography
            ...
            as="span"
            color="black"
            className="font-normal transition-colors dark:text-white hover:text-blue-500 focus:text-blue-500"
          >
            Made With &#10084;
          </Typography>
        </li>
        <li>
          <Typography
            ...
            target="_blank"
            color="blue-gray"
            className="font-normal dark:text-white transition-colors hover:text-blue-500 focus:text-blue-500"
          >
            <svg
        ...
        <li>
          <Typography
            ...
            onPointerLeaveCapture={undefined}
            as="a"
            href="https://github.com/Aymenbachiri"
            target="_blank"
            color="blue-gray"
            className="font-normal dark:text-white dark:bg-white rounded-full transition-colors hover:text-blue-500 focus:text-blue-500 "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
